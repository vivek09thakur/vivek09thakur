...
<p align="center">
    <!-- HTML5 -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/HTML5_Badge.svg/768px-HTML5_Badge.svg.png?20110131171049' width='35px' height='auto'/>
    <!-- CSS3 -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/CSS3_logo.svg/640px-CSS3_logo.svg.png' width='35px' height='auto'/>
    <!-- Javascript -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/9/99/Unofficial_JavaScript_logo_2.svg/640px-Unofficial_JavaScript_logo_2.svg.png' width='35px' height='auto'/>
    <!-- Bootstrap -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Bootstrap_logo.svg/640px-Bootstrap_logo.svg.png' width='42px' height='auto'/>
    <!-- ReactJs -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/a/a7/React-icon.svg/640px-React-icon.svg.png' width='35px' height='auto'/>
    <!-- NodeJs -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Node.js_logo_2015.svg/640px-Node.js_logo_2015.svg.png' width='60px' height='' style="margin-bottom:10px;margin-left:3px"/>
    <br/>
    <!-- C--->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/C_Logo.png/640px-C_Logo.png' width='35px' height='auto'/>
    <!-- C++ -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/1/18/ISO_C%2B%2B_Logo.svg/640px-ISO_C%2B%2B_Logo.svg.png' width='35px' height='auto'/>
    <!-- Python3 -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/c/c3/Python-logo-notext.svg/640px-Python-logo-notext.svg.png' width='35px' height='auto'/>
    <!-- Jupyter Notebook -->
    <img src='https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Jupyter_logo.svg/640px-Jupyter_logo.svg.png' width='35px' height='auto'/>
    <!-- Numpy -->
