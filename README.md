...
<p align="left">
    <p align="left">
        ...
        <!-- Languages and tools -->
        <img src='https://skillicons.dev/icons?i=html,css,c,cpp,js,bootstrap,git,github,nodejs,vite,react,nextjs,angular,express,svelte,python,tensorflow,pytorch,flask,django,mysql,googlecloud,figma,vscode,androidstudio&perline=6' width='auto' height='auto'/>
        <br/>
</p>
